    ...
    <div id="app">
        ...
        <header class="navbar bg-white shadow-sm px-4 d-flex justify-content-between align-items-center"
            ...
            <div class="d-flex align-items-center">
                ...
                {{-- <img src="{{ asset('images/fg_teacher.jpg') }}" alt="FeedGrow" height="30" class="me-2 mt-3"> --}}
                <div class="text-blue mt-4 ms-1">For TEACHER</div>
            ...
            <div class="d-flex align-items-center">
                ...
                @else
                    ...
                    <!-- ユーザー画像 -->
                    <a href="{{ route('teacher.profile.show', Auth::id()) }}" class="d-flex align-items-center">
